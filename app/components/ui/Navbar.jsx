    ...
    return (
        <>
            <nav className={`py-3 max-xl:px-5 ${isWhiteBg ? "bg-white" : "bg-primary-one"}`}>
                <div className="flex items-center justify-between gap-5 layout-container">
                    <Logo />
                    <div className="max-[830px]:hidden">
                        <NavMenu isWhiteBg={isWhiteBg} />
                    </div>
                    <div className="max-[830px]:hidden">
                        <SocialIcon isWhiteBg={isWhiteBg} />
                    </div>
